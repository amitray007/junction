...
| 17 | Source-agnostic debug surface — probe + call any source kind | `17-source-agnostic-debug.md` | written |
| 18 | Large-spec selection (--tag/--path) + spec refresh | `18-*.md` | TBD |

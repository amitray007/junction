...
| 24.5 | **Web: UX revamp** — rethink the dashboard from "management portal" toward a **normal-user / Composio-like connect-once experience** (information architecture, onboarding/empty states, the connect flow, approachability) + a designer's-eye polish + a11y pass across all pages. Design-led; not feature work. | `24.5-web-ux-revamp.md` (TBW) | planned |
